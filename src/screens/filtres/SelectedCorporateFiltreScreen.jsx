...
const LIMIT = 20
export default function SelectedCorporateFiltreScreen() {
        ...
        const { selectedCorporate } = route.params || {}
        ...
        const handleCorporatePress = corporate => {
                ...
                navigation.navigate("HistoriqueCourseScreen", { corporate: corporate })
        }
                                                                ...
                                                                <TouchableNativeFeedback onPress={() => handleCorporatePress(corporate)}>
                                                                        <View style={{ backgroundColor: shosenCorporate?.ID_CORP_CORPORATE == corporate.ID_CORP_CORPORATE ? '#f1f1f1' : '#fff', borderRadius: 8 }}>
                                                                                <View style={styles.institution}>
                                                                                        ...
                                                                                        {shosenCorporate?.ID_CORP_CORPORATE == corporate.ID_CORP_CORPORATE ? <MaterialCommunityIcons name="radiobox-marked" size={24} color="#007bff" /> :
