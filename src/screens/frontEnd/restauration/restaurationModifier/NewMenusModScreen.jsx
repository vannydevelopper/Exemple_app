...
export default function NewMenuScreen() {
          ...
          /**
           * Fonction pour ajouter autres sur les categories
           */
          ...
          const fetchCategories = async () => {
                    try {
                              const pdts = await fetchApi('/resto/restaurant_menus/restaurant_categorie_menu')
                              setCategories(pdts)
                    } catch (error) {
                              console.log(error)
                    } finally {
          ...
          const onSubmit = async () => {
                    try {
                              ...
                              const newProduct = await fetchApi('/resto/restaurant_menus',{
                                        method: "POST",
                                        body: form
                              })
                              navigation.goBack()
                                                  ...
                                                  {categories.result?.map((produit, index) => {
                                                            return (
                                                                      ...
                                                                      onPress={() => selectCategorie(produit)}>
                                                                                <View key={index} style={[styles.modalItem, produit.ID_CATEGORIE_MENU == data.category?.ID_CATEGORIE_MENU && { backgroundColor: '#ddd' }]} >
                                                      ...
                                                      <TouchableNativeFeedback onPress={checkAutres}>
