...
import { Text, useWindowDimensions, View, StyleSheet, FlatList, Image } from "react-native";
import Animated,{ useAnimatedStyle, useSharedValue, withSpring } from "react-native-reanimated";

const IMAGES = [{
        uri: require('../../../assets/menus/family.jpg')
}, {
        uri: require('../../../assets/menus/delivery.jpg')
}, {
        uri: require('../../../assets/menus/delivery.jpg')
}]
...
export default function Carousel() {
        ...
        const [activendex, setActiveIndex] = useState()
        useEffect(() => {
